...
for name, function in (
    ...
    ("retry_all_panels", services.retry_all_panels),
    ("adopt_panel", services.adopt_panel),
    ("grow_lora_from_panels", services.grow_lora_from_panels),
...
for path, methods, function in (
    ...
    ("/api/panel/retry-all", ["POST"], services.retry_all_panels),
    ("/api/panel/adopt", ["POST"], services.adopt_panel),
    ("/api/bible/grow", ["POST"], services.grow_lora_from_panels),
