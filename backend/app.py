...
for name, function in (
    ...
    ("start_preview_pair", services.start_preview_pair),
    ...
    ("relearn_preview", services.relearn_preview),
    ("grow_lora_from_preview", services.grow_lora_from_preview),
    ("adopt_preview_lora", services.adopt_preview_lora),
    ("generate_character_sheet", services.generate_character_sheet),
    ("regenerate_character_sheet", services.regenerate_character_sheet),
    ("approve_character_sheet", services.approve_character_sheet),
    ...
    ("get_sheet_layout", services.get_sheet_layout),
    ("save_sheet_layout", services.save_sheet_layout),
    ("confirm_sheet_layout", services.confirm_sheet_layout),
    ("discard_sheet_layout", services.discard_sheet_layout),
    ("redraw_panel", services.redraw_panel),
    ("retry_panel", services.retry_panel),
    ("adopt_panel", services.adopt_panel),
    ...
    ("set_character_strength", services.set_character_strength),
...
for path, methods, function in (
    ...
    ("/api/characters/{name}", ["DELETE"], services.delete_character),
    ("/api/characters/{name}/strength", ["POST"], services.set_character_strength),
    ("/api/characters/{name}/layout", ["GET"], services.get_sheet_layout),
    ("/api/characters/{name}/layout", ["POST"], services.save_sheet_layout),
    ("/api/layout/{job_id}/confirm", ["POST"], services.confirm_sheet_layout),
    ("/api/layout/{job_id}/discard", ["POST"], services.discard_sheet_layout),
    ...
    ("/api/characters/{name}/preview-pair", ["POST"], services.start_preview_pair),
    ("/api/characters/{name}/previews/{job_id}/reviews", ["GET"], services.preview_reviews),
    ("/api/characters/{name}/previews/{job_id}/reviews/{image_id}", ["POST"], services.save_preview_review),
    ("/api/characters/{name}/previews/{job_id}/reviews/{image_id}/interpretation", ["POST"], services.correct_preview_interpretation),
    ("/api/characters/{name}/previews/{job_id}/relearn", ["POST"], services.relearn_preview),
    ("/api/characters/{name}/previews/{job_id}/grow", ["POST"], services.grow_lora_from_preview),
    ("/api/characters/{name}/previews/{job_id}/adopt", ["POST"], services.adopt_preview_lora),
    ("/api/characters/{name}/sheet", ["POST"], services.generate_character_sheet),
    ("/api/characters/{name}/sheet/regenerate", ["POST"], services.regenerate_character_sheet),
    ("/api/characters/{name}/sheet/approve", ["POST"], services.approve_character_sheet),
    ...
    ("/api/panel/retry", ["POST"], services.retry_panel),
    ("/api/panel/adopt", ["POST"], services.adopt_panel),
