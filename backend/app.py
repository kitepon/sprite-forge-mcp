...
for name, function in (
    ...
    ("revise_preview_instruction", services.revise_preview_instruction),
    ("propose_material_revision", services.propose_material_revision),
    ("remake_lora_from_revision", services.remake_lora_from_revision),
...
for path, methods, function in (
    ...
    ("/api/characters/{name}/previews/{job_id}/revise", ["POST"], services.revise_preview_instruction),
    ("/api/characters/{name}/previews/{job_id}/remake", ["POST"], services.propose_material_revision),
    ("/api/characters/{name}/material-revisions/{request_id}", ["POST"], services.remake_lora_from_revision),
