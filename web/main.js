...
import { FLOWS, flow, cover, openFlow } from './flows.js?v=studio-10';
import { jobs, operations, active, connectionError, subscribe, refreshJobs, startJobUpdates, tickElapsed, terminal, kindLabel, imagePaths, jobView, taskPanel } from './jobs.js?v=studio-7';
